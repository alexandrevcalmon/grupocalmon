        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            <p className="text-sm text-gray-500">
              Cientista de Dados, Neurocientista, Especialista em IA Generativa e Transformação Digital
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <img
            ...
            <p className="text-sm text-gray-500">
              Mestre em Saúde Mental - Terapeuta - Palestrante sobre Inteligência Emocional
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <img
            ...
            <p className="text-gray-600 mb-2">Consultor Parceiro de IA na Medicina</p>
            <p className="text-sm text-gray-500">
